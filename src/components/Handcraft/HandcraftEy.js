...
const HandcraftEy = ({ handcraftEy, sethandcraftEy }) => {
  return (
    <div
    ...
    >
      <ExitButton
        detail
        onClick={() => sethandcraftEy(!handcraftEy)}
      ></ExitButton>
            ...
            >
              <div className="w-52 ">
                {/* <div className="absolute top-16 left-7 z-10 ">
                  ...
                  <img
                    src="/Beverages/ey_frenchpress.png"
                    alt=""
                    className="w-[52px] h-full object-cover"
                  />
                </div> */}
